...
class Tmp(nn.Module):
    ...
    def __init__(self, in_shape=3):
        ...
        self.seq1 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=(1, 1), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=64, eps=0.01190501889324183),
            nn.ReLU(),
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=(1, 1), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=64, eps=0.01190501889324183),
            ...
            nn.BatchNorm2d(num_features=64, eps=0.01190501889324183),
            nn.ReLU(),
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(3, 3), stride=(2, 2), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=128, eps=0.01190501889324183),
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(3, 3), stride=(1, 1), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=128, eps=0.01190501889324183),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(1, 1), stride=(2, 2), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=128, eps=0.01190501889324183),
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(3, 3), stride=(1, 1), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=128, eps=0.01190501889324183),
            ...
            nn.BatchNorm2d(num_features=128, eps=0.01190501889324183),
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(3, 3), stride=(2, 2), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=256, eps=0.01190501889324183),
            nn.ReLU(),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=(3, 3), stride=(1, 1), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=256, eps=0.01190501889324183),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=(1, 1), stride=(2, 2), padding=[0, 0], dilation=(1, 1)),
            nn.BatchNorm2d(num_features=256, eps=0.01190501889324183),
            nn.ReLU(),
